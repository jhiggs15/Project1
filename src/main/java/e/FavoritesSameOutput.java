...
public class FavoritesSameOutput {
    ...
    public static class FavoritesReducer
        ...
        public void reduce(IntWritable key, Iterable<IntWritable> values,
            ...
            IntWritable numberOfPages = new IntWritable(0);
//            Set<IntWritable> uniquePages = new HashSet<>();
            for (IntWritable whatPage : values) {
                numberOfPages.set(numberOfPages.get() + 1); // counts the number of pages each user has visited
//                uniquePages.add(whatPage); // tracks unique pages the user visited
            }
            context.write(key, numberOfPages);
...
//            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(FavoritesSameOutput.class);
        job.setMapperClass(FavoritesSameOutput.FavoritesMapper.class);
        job.setReducerClass(FavoritesSameOutput.FavoritesReducer.class);
